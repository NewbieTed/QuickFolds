...
-- frontend make button to hook up to editor if sucessful api call
    ...
    -- if of face object created is 0, vertices are id 0, 1, 2, 3... cc
    -- edges id are 0, 1, 2, 3 cc with bottom being first

-- origami id: 1, face id: 0, new verticeid to add 10, user id: 1, next step id for point: 1, step type: 1

BEGIN;

INSERT INTO users (username, password, created_by, updated_by, created_at, updated_at) VALUES
('alice', 'password', 'admin', 'admin', '2024-02-10 12:00:00+00', '2024-02-10 12:00:00+00');


--
-- 2) STEP TYPE
--
-- Three example step types: fold, annotate, rotate
-- The first will be id=1, second=2, third=3.
--
...
-- 3) POINT TYPE
--
-- Two example point types: vertex, annotated_point
-- The first will be id=1, second=2.
--
...
-- 4) EDGE TYPE
--
-- Two example edge types: side, fold
-- The first will be id=1, second=2.
--
